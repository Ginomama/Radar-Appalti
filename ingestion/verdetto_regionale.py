...
CHI_SIAMO = (
    ...
    "Attenzione a 'studio di fattibilita'', 'analisi preliminare', 'progetto "
    "di fattibilita' tecnico-economica': se il bando chiede SOLO un documento/"
    "report (anche se descrive una futura piattaforma software), e' un "
    "prodotto diverso da quello che sappiamo fare — non e' 'no' automatico, "
    "ma quasi mai 'si' netto, perche' spesso richiede competenze economiche/"
    "normative di settore che un'agenzia di sviluppo non ha. Se invece il "
    "bando chiede di realizzare o sviluppare qualcosa (anche solo un "
    "prototipo), resta nel nostro perimetro.\n\n"
